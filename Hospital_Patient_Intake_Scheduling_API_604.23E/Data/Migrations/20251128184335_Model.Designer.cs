...
namespace Hospital_Patient_Intake_Scheduling_API_604._23E.Data.Migrations
{
    ...
    [Migration("20251128184335_Model")]
    partial class Model
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hospital_Patient_Intake_Scheduling_API_604._23E.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PasswordHash = "$2a$11$oDRQ.5grmHF/UrkK4rIOeOez5igadhyjMxIE7DR7MQK88HallU1CC",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            PasswordHash = "$2a$11$Cby/P8fCtwAtKQfcOdgc2eCbXBYA7yqH2Y/iZN/WNeCXvBJmYRQVq",
                            Role = "Receptionist",
            ...
            modelBuilder.Entity("Hospital_Patient_Intake_Scheduling_API_604._23E.Models.Doctor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            PasswordHash = "$2a$11$CZiJ0KBj6EfsPVm6UPnOdu7HcjVFsgtgSWMiwzyUCYXwI.9ADIMx6",
                            Role = "Doctor",
                            Username = "hasan",
            ...
            modelBuilder.Entity("Hospital_Patient_Intake_Scheduling_API_604._23E.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            PasswordHash = "$2a$11$GbB3EL7S4a3K8ogh/vKeweViM/W4jFlmTD2LIJuj.T2rldxiwaPKG",
                            Role = "Patient",
                            Username = "sevinc",
                            Address = "Ahmadli",
                            Age = 19,
                            CreatedAt = new DateTime(2025, 11, 28, 18, 43, 35, 500, DateTimeKind.Utc).AddTicks(9786),
                            Email = "sevinc@gmail.com",
                            Name = "Sevinc Abbasova",
                            PhoneNumber = "+994555555555",
                            Symptoms = "Headache, nausea, dizziness",
                            UpdatedAt = new DateTime(2025, 11, 28, 18, 43, 35, 500, DateTimeKind.Utc).AddTicks(9796)
                        });
                });
